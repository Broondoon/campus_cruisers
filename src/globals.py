...
After some research, I've learned that the best practice to avoid circular dependency
is to just have a globals.py file that others import.

Hopefully this works!

"""
from util.data_types import Node
